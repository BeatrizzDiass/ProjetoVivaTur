...
// Registrar CDNs externos
$this->registerCssFile('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css');
$this->registerCssFile('https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css');

$this->registerJsFile('https://code.jquery.com/jquery-3.4.1.min.js', ['position' => \yii\web\View::POS_HEAD]);
$this->registerJsFile('https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js', ['position' => \yii\web\View::POS_END]);
...
?>
    ...
    <head>
        ...
        <title><?= Html::encode($this->title) ?> - VivaTur</title>
