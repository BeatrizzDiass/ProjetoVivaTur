...
$this->title = "Experiências Respondidas";
?>
<div class="container-fluid bg-primary py-5 mb-5 hero-header">
    <div class="container py-5">
        <div class="row justify-content-center py-5">
            <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-3 text-white animated slideInDown">Experiências respondidas por <?= Yii::$app->user->identity->username ?></h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <?php if(empty($comentarios)): ?>
                <div class="col-12 text-center">
                    <p class="text-muted">Ainda não respondeu a nenhum comentário.</p>
                </div>
            <?php else: ?>
                            ...
                            <div class="card-body d-flex flex-column align-items-center justify-content-center text-center">
                                ...
                                <div class="mb-2">
                                    <small class="text-muted">
                                        ...
                                        <?= date('d/m/Y', strtotime($comentario->dataResposta)) ?>
                                    </small>
                                </div>

                                <p class="card-text" style="font-style: italic; font-size: 0.9rem;"> Resposta:
